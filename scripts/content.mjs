...
function renderServicePage(content, service, resource) {
  ...
  const partnerDirectory = service.slug === 'is-ortaklari' ? `<section class="content-section partner-directory" aria-labelledby="partner-directory-title"><div class="section-heading partner-directory-heading"><p class="eyebrow">Ağ dizini · Hazırlık aşaması</p><h2 id="partner-directory-title">Doğrulanmış çözüm ortakları burada listelenecek</h2><p>Kuruluş adı veya logo paylaşmadan önce kapsam, yetkinlik, hizmet bölgesi ve veri/marka kullanım koşullarını doğruluyoruz.</p></div><div class="partner-status-board"><div class="partner-status-copy"><span class="status-pill">Yakında yayınlanacak</span><h3>İşbirliği alanlarını şeffaf bir partner kartında göstereceğiz</h3><p>Liste aktif olduğunda her kartta ortaklığın rolü, hizmet alanı, bölgesi, iletişim kapsamı ve doğrulama notu açıkça yer alacak.</p></div><dl class="partner-field-list" aria-label="Planlanan partner kartı alanları"><div><dt>01</dt><dd>Uzmanlık ve rol</dd></div><div><dt>02</dt><dd>Hizmet bölgesi</dd></div><div><dt>03</dt><dd>Çalışma kapsamı</dd></div><div><dt>04</dt><dd>Doğrulama notu</dd></div></dl></div><div class="partner-placeholder-grid"><article class="partner-placeholder"><span class="service-number">01</span><span class="partner-placeholder-label">Partner kartı bekliyor</span><h3>Belgelendirme ve değerlendirme</h3><p>Bağımsız belgelendirme veya değerlendirme ihtiyacı doğduğunda rol ve karar sınırları açıkça tanımlanacak.</p></article><article class="partner-placeholder"><span class="service-number">02</span><span class="partner-placeholder-label">Partner kartı bekliyor</span><h3>Test, analiz ve doğrulama</h3><p>Teknik ölçüm, test veya analiz hizmetleri; numune akışı ve raporlama sorumluluğuyla birlikte gösterilecek.</p></article><article class="partner-placeholder"><span class="service-number">03</span><span class="partner-placeholder-label">Partner kartı bekliyor</span><h3>Eğitim ve sektörel uzmanlık</h3><p>Eğitim, saha uygulaması veya sektörel konu uzmanlığı için ortak çalışma kapsamı netleştirilecek.</p></article><article class="partner-placeholder"><span class="service-number">04</span><span class="partner-placeholder-label">Partner kartı bekliyor</span><h3>İhtiyaca özel uzmanlık</h3><p>Projenin gerektirdiği yeni uzmanlık başlıkları, uygunluk ve kaynak doğrulamasından sonra bu alana eklenecek.</p></article></div><p class="partner-footnote"><strong>Yayın ilkesi:</strong> Bu sayfada yalnızca kapsamı, rolü ve paylaşım izni netleştirilmiş ortaklıklar yer alacaktır. Sertifikasyon veya akreditasyon iddiası için ilgili kuruluşun resmî kaynağı esas alınır.</p></section>` : '';
...
function renderServiceCatalog(content) {
  ...
  const contentHtml = `<div class="container">${breadcrumb([{ label: 'Ana Sayfa', href: 'index.html' }, { label: 'Hizmet Kataloğu' }])}<section class="content-section"><div class="section-heading"><p class="eyebrow">${content.services.length} danışmanlık kapsamı · veri tabanlı katalog</p><h2>İhtiyacınıza göre hizmet kapsamını seçin</h2><p>Her kapsam; başlama sinyalini, beklenen teslimatı ve ilk görüşmeye hazırlanacak veriyi görünür kılar. Sektörel ve operasyonel ihtiyaçlarınızı ilgili çalışma sayfasına taşıyın.</p></div><div class="service-grid">${cards}</div></section></div>`;
