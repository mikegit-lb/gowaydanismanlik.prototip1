...
const criticalShellCss = `.utility,.topbar{position:relative;isolation:isolate;overflow:hidden;min-height:46px;background:linear-gradient(90deg,#0d4b67 0%,#155d79 52%,#0f4b68 100%);color:#f4f8fb}.utility::after,.topbar::after{position:absolute;z-index:-1;inset:0;background:radial-gradient(circle at 50% -90%,rgb(244 248 251 / .2),transparent 50%);content:"";pointer-events:none}.utility .container,.topbar-inner{position:relative;z-index:1;min-height:46px;display:grid;grid-template-columns:minmax(0,1fr) minmax(260px,.9fr) minmax(0,1fr);align-items:center;gap:18px}.utility .container>span,.utility .container>a,.topbar-context,.topbar-phone{display:inline-flex;min-height:28px;align-items:center;gap:8px}.utility .container>span,.topbar-context{grid-column:1}.utility .container>a,.topbar-phone{grid-column:3;justify-self:end;padding:6px 11px;border:1px solid rgb(244 248 251 / .24);border-radius:999px;background:rgb(244 248 251 / .06);font-size:.76rem;font-weight:800}.site-slogan-ticker,.topbar-ticker{grid-column:2;min-width:0;width:100%;padding-inline:18px;border-inline:1px solid rgb(244 248 251 / .15)}`;
